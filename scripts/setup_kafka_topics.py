#!/usr/bin/env python3
"""
Kafka Topic Setup Script for Job Platform

This script creates all the required Kafka topics for the microservices architecture.
It should be run after Kafka is started and before starting the services.
"""
...
from kafka_utils import get_event_publisher
...
def test_kafka_connection(bootstrap_servers):
    ...
    try:
        publisher = get_event_publisher(bootstrap_servers)
